...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        // T0DO (5) Store an address in a String

        String mAddress=  "restaurants";
        Uri.Builder builder= new Uri.Builder();
            builder.scheme("geo")
                    .path("37.7749,-122.4194")
                    .query(mAddress);
        ...
        // T0DO (6) Use Uri.Builder with the appropriate scheme and query to form the Uri for the address

        // T0DO (7) Replace the Toast with a call to showMap, passing in the Uri from the previous step
       // Toast.makeText(this, "T0DO: Open a map when this button is clicked", Toast.LENGTH_SHORT).show();
    }
    ...
    private void showMap(Uri uri) {
        ...
        // T0DO (1) Create a method called showMap with a Uri as the single parameter
        // Do steps 2 - 4 within the showMap method
        // T0DO (2) Create an Intent with action type, Intent.ACTION_VIEW

        // T0DO (3) Set the data of the Intent to the Uri passed into this method
