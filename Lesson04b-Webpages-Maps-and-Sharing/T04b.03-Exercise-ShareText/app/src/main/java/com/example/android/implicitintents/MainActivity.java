...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        String stringToShare = "This is the string i just share";
        // T0DO (5) Specify a String you'd like to share
        shareText(stringToShare);

        // T0DO (6) Replace the Toast with shareText, passing in the String from step 5
    }
    ...
    public void createYourOwn(View v) {
        ...
        intentDialer.setData(Uri.parse("tel:00237698558899"));
    ...
    private void shareText(String string) {
        ...
        String title = "completing action using  ?";
...
// T0DO (1) Create a void method called shareText that accepts a String as a parameter
// Do steps 2 - 4 within the shareText method

// T0DO (2) Create a String variable called mimeType and set it to "text/plain"

// T0DO (3) Create a title for the chooser window that will pop up

// T0DO (4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
