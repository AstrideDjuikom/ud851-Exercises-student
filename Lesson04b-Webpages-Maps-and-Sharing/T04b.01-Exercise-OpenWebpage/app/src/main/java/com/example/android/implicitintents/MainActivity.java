...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        String stringUrl="https://github.com/AstrideDjuikom/ud851-Sunshine-student";
        openWebPage(stringUrl);
        // T0DO (5) Create a String that contains a URL ( make sure it starts with http:// or https:// )

        // T0DO (6) Replace the Toast with a call to openWebPage, passing in the URL String from the previous step
    }
    ...
    public void createYourOwn(View v) {
        Toast.makeText(this,"TODO: Create Your Own Implicit Intent",Toast.LENGTH_SHORT)
                .show();
    }

    // T0DO (1) Create a method called openWebPage that accepts a String as a parameter
    // Do steps 2 - 4 within openWebPage
    public void openWebPage(String string){
        Uri UriString=Uri.parse(string);
        ...
        // T0DO (2) Use Uri.parse to parse the String into a Uri

        // T0DO (3) Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters

        // T0DO (4) Verify that this Intent can be launched and then call startActivity
}