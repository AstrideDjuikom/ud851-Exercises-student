...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // T0DO (1) Use logAndAppend within onCreate
    ...
    // T0DO (2) Override onStart, call super.onStart, and call logAndAppend with ON_START

    // T0DO (3) Override onResume, call super.onResume, and call logAndAppend with ON_RESUME

    // T0DO (4) Override onPause, call super.onPause, and call logAndAppend with ON_PAUSE

    // T0DO (5) Override onStop, call super.onStop, and call logAndAppend with ON_STOP

    // T0DO (6) Override onRestart, call super.onRestart, and call logAndAppend with ON_RESTART

    // T0DO (7) Override onDestroy, call super.onDestroy, and call logAndAppend with ON_DESTROY
