...
// T0DO (1) Use Android Studio's Activity wizard to create a new Activity called ChildActivity

// Do steps 2 - 5 in activity_child.xml
// T0DO (2) Change the ConstraintLayout to a FrameLayout and make appropriate adjustments
// T0DO (3) Give your TextView an ID of tv_display
// T0DO (4) Set the text to something that indicates this is default text being displayed
// T0DO (5) Make the text size a little larger

// Do steps 6 & 7 in ChildActivity.java
// T0DO (6) Create a TextView field to display your message
// T0DO (7) Get a reference to your TextView in Java