    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // T0DO (1) Store ChildActivity.class in a Class object called destinationActivity

                // T0DO (2) Create an Intent to start ChildActivity

                // T0DO (3) Replace the Toast with code to start ChildActivity
