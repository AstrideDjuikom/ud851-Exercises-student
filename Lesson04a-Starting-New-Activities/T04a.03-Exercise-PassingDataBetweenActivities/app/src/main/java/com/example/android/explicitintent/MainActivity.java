    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // T0DO (1) Retrieve the text from the EditText and store it in a variable
                String nameEnterred=mNameEntry.getText().toString();
                ...
                startChildActivityIntent.putExtra(Intent.EXTRA_TEXT,nameEnterred);

                // T0DO (2) Use the putExtra method to put the String from the EditText in the Intent
