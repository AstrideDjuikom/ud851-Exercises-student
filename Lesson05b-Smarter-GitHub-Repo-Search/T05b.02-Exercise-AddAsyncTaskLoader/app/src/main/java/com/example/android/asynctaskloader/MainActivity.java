...
// T0DO(1) implement LoaderManager.LoaderCallbacks<String> on MainActivity
public class MainActivity extends AppCompatActivity implements
    ...
    // TOD0 (28) Remove the key for storing the search results JSON

    // TOD0 Create a constant int to uniquely identify your loader. Call it GITHUB_SEARCH_LOADER
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            // TOD0 (26) Remove the code that retrieves the JSON

            mUrlDisplayTextView.setText(queryUrl);
            // TOD0 (25) Remove the code that displays the JSON
        }
    ...
    private void makeGithubSearchQuery() {
        ...
        // tod0 (18) Remove the call to execute the AsyncTask

        // TOD0 (19) Create a bundle called queryBundle
        Bundle queryBundle = new Bundle();
        // TOD0 (20) Use putString with SEARCH_QUERY_URL_EXTRA as the key and the String value of the URL as the value
        queryBundle.putString(SEARCH_QUERY_URL_EXTRA, githubSearchUrl.toString());

        // TOD0 Call getSupportLoaderManager and store it in a LoaderManager variable
        LoaderManager loaderManager = getSupportLoaderManager();
        // TOD0 (22) Get our Loader by calling getLoader and passing the ID we specified
        Loader<String> githubSearchLoader = loaderManager.getLoader(GITHUB_SEARCH_LOADER);
        // TOD0 (23) If the Loader was null, initialize it. Else, restart it.
    ...
    // TOD0(3) Override onCreateLoader
    @Override
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        // TOD0 (4) Return a new AsyncTaskLoader<String> as an anonymous inner class with this as the constructor's parameter
        return new AsyncTaskLoader<String>(this) {

            // TOD0 (5) Override onStartLoading
            @Override
            protected void onStartLoading() {

                // TOD0 (6) If args is null, return.
                if (args == null) {
                    return;
                }
            ...
            public String loadInBackground() {
                ...
                // TOD0 (10) Get the String for our URL from the bundle passed to onCreateLoader
